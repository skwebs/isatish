...
const Navbar = () => {
  ...
  return (
    <>
      ...
      {/* Mobile Menu */}
      <div className={`fixed inset-0 bg-slate-950 z-[100] transition-transform duration-300 md:hidden ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
        <div className="absolute top-5 right-6">
          <button className="text-white" onClick={() => setIsOpen(false)}>
            <X size={24} />
          </button>
        </div>
        <div className="flex flex-col items-center gap-8 pt-32 px-6">
